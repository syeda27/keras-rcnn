...
class ResNet50RCNN(keras.models.Model):
    """
    ...
    def __init__(self, inputs, classes, rois=300, blocks=[3, 4, 6], *args, **kwargs):
        ...
        super(ResNet50RCNN, self).__init__(inputs, [scores, boxes, features, rpn_classification_loss, rpn_regression_loss], *args, **kwargs)
